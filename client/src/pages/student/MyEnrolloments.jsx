  ...
  return (
    <>
      <div className='px-8 pt-10 md:px-36'>
        <h1 className='text-2xl font-semibold'>My Enrolloments</h1>
        <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
          ...
          <tbody className='text-gray-700'>
            {enrolledCourses.map((course,index)=>(
              <tr className='border-b border-gray-50/20' key={index}>
                <td className='md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3'>
                  ...
                  <div className='flex-1'>
                    ...
                    <Line 
                      ...
                      strokeWidth={2} 
                      strokeColor="#2563eb"   // blue-600 color
                      trailColor="#d1d5db"    // gray-300 color
